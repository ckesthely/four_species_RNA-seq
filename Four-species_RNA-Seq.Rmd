...
comparisons <- c("B", "B", "B", "B", "A", "A", "A", "A", "C", "C", "C", "C", "D", "D", "D", "D", "E", "E", "E", "E", "F", "F", "F", "F", "G", "G", "G", "G", "H", "H", "H", "H", "I", "I", "I", "I")
...
PA14_colData <- mutate(PA14_colData, comparisons)
...
PA14_colData$comparisons <- as.factor(PA14_colData$comparisons)
...
PA14_heatmap <- pheatmap(PA14_mat, annotation_col = PA14_anno, fontsize_row = 8.5, name = "log2FC",
                         annotation_colors = PA14_heatmap_legend_cols, show_colnames = FALSE)
plot(PA14_heatmap)
...
Staph_heatmap <- pheatmap(Staph_mat, annotation_col = Staph_anno, fontsize_row = 8.5, name = "log2FC", 
                          annotation_colors = Staph_heatmap_legend_cols, show_colnames = FALSE)
plot(Staph_heatmap)
...
Strep_heatmap <- pheatmap(Strep_mat, annotation_col = Strep_anno, fontsize_row = 6.5, name = "log2FC", 
                          annotation_colors = Strep_heatmap_legend_cols, show_colnames = FALSE)
plot(Strep_heatmap)
...
Prev_heatmap <- pheatmap(Prev_mat, annotation_col = Prev_anno, fontsize_row = 6.5, name = "log2FC", 
                         annotation_colors = Prev_heatmap_legend_cols, show_colnames = FALSE)
plot(Prev_heatmap)
```
...
venn.diagram(x = list(Pseudo_Mix_swap_down$Locus_tag, Pseudo_Mix_tob_down$Locus_tag, Pseudo_Mix_lasR_swap_down$Locus_tag, Pseudo_Mix_tob_down$Locus_tag),
             category.names = c("Mix_swap", "Mix_tob","Mix_\U0394lasR_swap", 
                                "Mix_\U0394lasR_tob"),
             ...
             scaled = TRUE,
             margin = 0.02,
             cat.fontface = c('plain', 'plain', 'plain', 'plain'))
...
Pseudo_upset_plot_up <- Pseudo_upset_up %>%
  ...
  ylab("Count") +
  theme(axis.title.x = element_text(size = 20, face = "bold"),
        axis.title.y = element_text(size = 20, vjust = -14, face = "bold"),
        axis.text.y = element_text(size = 14)) + 
  scale_y_continuous(breaks = seq(0, 200, by = 50), limits = c(0,200))
...
plot_grid(Pseudo_upset_plot_up, Pseudo_upset_plot_down, nrow = 1, ncol = 2)
plot_grid(Staph_upset_plot_up, Staph_upset_plot_down, nrow = 1, ncol = 2)
plot_grid(Strep_upset_plot_up, Strep_upset_plot_down, nrow = 1, ncol = 2)
plot_grid(Prev_upset_plot_up, Prev_upset_plot_down, nrow = 1, ncol = 2)
```
...
PA14_dist_matrix_heatmap <- PA14_vs_mix_dist %>%
  ...
  theme(panel.grid.major.x = element_blank(), 
        ...
        plot.title = element_text(hjust = .75, face = "italic", size = 18))
...
Prev_dist_matrix_heatmap <- Prev_vs_mix_dist %>%
  ...
  theme(panel.grid.major.x = element_blank(),
        ...
        axis.text.x = element_text(size = 16),
        axis.text.y = element_text(size = 16),
        plot.title = element_text(hjust = 1.5, face = "italic", size = 18))
  
plot(Prev_dist_matrix_heatmap)

plot_grid(PA14_dist_matrix_heatmap, Staph_dist_matrix_heatmap, Strep_dist_matrix_heatmap, Prev_dist_matrix_heatmap, ncol = 4)
```
...
Rendi_Screen_plot <- Rendi_data %>%
  ...
  geom_signif(comparisons = list(c("PA14", "Streptococcus")), map_signif_level = TRUE, y_position = c(4.25)) +
...
combined <- plot_grid(Rendi_Screen_plot, Bassam_Screen_plot, labels = "AUTO", label_size = 24)
